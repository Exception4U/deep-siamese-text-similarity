...
tf.flags.DEFINE_string("vocab_filepath", "runs/1495108944/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1495108944/checkpoints/model-41000", "Load trained model checkpoint (Default: None)")
