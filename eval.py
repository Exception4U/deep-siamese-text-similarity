...
tf.flags.DEFINE_string("model", "runs/1501270080/checkpoints/model-6200", "Load trained model checkpoint (Default: None)")
tf.flags.DEFINE_string("eval_filepath", "/media/root/Heavy_Dataset/gta_data/final/", "Evaluate on this data (Default: None)")
#tf.flags.DEFINE_string("vocab_filepath", "runs/1491122519/checkpoints/vocab", "Load training time vocabulary (Default: None)tf.flags.DEFINE_string("model", "runs/1491122519/checkpoints/model-99000", "Load trained model checkpoint (Default: None)")
